...
flags.DEFINE_string("record_info_dir", default='proc_data/pretrain/tfrecords',
      help="Path to local directory containing `record_info-lm.json`.")
flags.DEFINE_string("model_dir", default='models',
      help="Estimator model_dir.")
flags.DEFINE_string("init_checkpoint", default=None,#'downloads/xlnet_cased_L-12_H-768_A-12',
...
flags.DEFINE_integer('perm_size', default=32,
  help='perm size.')
...
# Model config
flags.DEFINE_integer("mem_len", default=96,
...
flags.DEFINE_integer("d_inner", default=4096,
