...
if __name__ == "__main__":
  ...
  flags.DEFINE_integer("num_core_per_host", 16, help="num TPU cores per host.")
  ...
  flags.DEFINE_string("input_glob", "data/pretrain/*.txt",
                      help="Input file glob.")
  flags.DEFINE_string("sp_path", "downloads/xlnet_cased_L-12_H-768_A-12/spiece.model",
                      help="Path to the sentence piece model.")
  flags.DEFINE_string("save_dir", "proc_data/pretrain",
