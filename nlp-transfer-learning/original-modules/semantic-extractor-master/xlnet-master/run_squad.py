...
flags.DEFINE_string("model_dir", default="./models/exp/squad",
...
flags.DEFINE_integer("save_steps", default=5,
...
# Eval / Prediction
flags.DEFINE_bool("do_predict", default=True, help="whether to do predict")
...
def read_squad_examples(input_file, is_training):
  ...
  examples = []     ; print(json.dumps(input_data[0]))
...
class FeatureWriter(object):
  ...
  def process_feature(self, feature):
    ...
    f={'unique_ids':feature.unique_id,'input_ids':feature.input_ids,'input_mask':feature.input_mask,'p_mask':feature.p_mask,'segment_ids':feature.segment_ids}
    ...
    f['cls_index']=feature.cls_index;f['start_positions']=feature.start_position;f['end_positions']=feature.end_position
    if self.is_training:
    ...
    f['is_impossible'] = impossible;    print(json.dumps(f))
