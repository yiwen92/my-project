...
tf.app.flags.DEFINE_string("model_dir", './model_FFM/FFM', "model check point dir")
...
field2fields = []; field2fields.extend([0] * 6); field2fields.extend([1] * 6); field2fields.extend([2] * 6)
field2feature = [i for i in range(FLAGS.feature_size)]
ffm_params = {
    'field2feature': field2feature,
    'field2fields': field2fields,
